...
var _sortingFields = require("./containers/sorting-fields.js");

var _sortingFields2 = _interopRequireDefault(_sortingFields);
  ...
  function App(props) {
    ...
    _this.search = function (append) {
      var _this$state = _this.state,
          ...
          availSort = _this$state.availSort,
          makeSort = _this$state.makeSort,
          sortOrder = _this$state.sortOrder,
          page = _this$state.page;

      var url = _this.baseUrl + "/search/repositories?page=" + page + "&q=" + searchTerm;
      var self = _this;
      if (!searchTerm) {
        return;
      }
      if (availSort.includes(sortField)) {
        ...
        _this.manualSort(url, sortField, sortOrder[sortField]);
        return;
      } else {
        return;
      }
    ...
    _this.manualSort = function (url, sort, order) {
      var sorted = [];
      self = _this;
      _this.axget(url, function (data) {
    ...
    _this.sortBy = function (e) {
      var target = e.target;
      var value = _this.getSortType(target.innerHTML);
      _this.setState({
        sortField: value,
        sortOrder: _defineProperty({}, value, _this.state.sortOrder[value] && _this.state.sortOrder[value] === "asc" ? "desc" : "asc")
      }, function () {
        this.search();
      });
    };
    ...
    _this.baseUrl = "https://api.github.com";
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      if (cardData && cardData.length > 0) {
        cards = cardData.map(function (card) {
      ...
      var cardContainer = _react2.default.createElement(
        "div",
        { className: "card-container flex-3" },
        cards
      );

      //Sorting Arrow Icons
      var upArrow = _react2.default.createElement("i", { className: "fa fa-arrow-up" });
      var downArrow = _react2.default.createElement("i", { className: "fa fa-arrow-down" });

      //No Response/Error Received
      var nonRecv = _react2.default.createElement(
        "div",
        { className: "fourOFour" },
        searchError ? searchError : "Nothing to show"
      );

      //Sorting Fields Container
      var sortContainer = _react2.default.createElement(
        "div",
        { className: "sort-container flex flex-1 margin-top-26 flex-col" },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "span",
            null,
            sortOrder[sortField] === 'asc' ? downArrow : upArrow
          ),
          _react2.default.createElement(
            "span",
            { className: "font-700 margin-left-4" },
            "Sort"
          ),
          " "
        ),
        _react2.default.createElement(_sortingFields2.default, {
          data: ["Name", "Stars", "Watchers", "Created Date", "Updated Date", "Score"],
...
},{"./components/card.js":54,"./containers/sorting-fields.js":55,"axios":1,"react":52,"react-dom":49}],54:[function(require,module,exports){
"use strict";
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement("img", { src: data.owner.avatar_url, alt: "" })
      )
    ),
    _react2.default.createElement(
      "div",
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "icon-font flex flex-1 flex-align-center" },
          _react2.default.createElement(
            "div",
            null,
        ...
        _react2.default.createElement(
          "div",
          { className: "flex flex-1 flex-align-center" },
          data.language ? _react2.default.createElement(
            "div",
            { className: "badge" },
            data.language
          ) : _react2.default.createElement(
...
},{"react":52}],55:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = SortingFields;
...
function SortingFields(props) {
  ...
  var mappedList = data.map(function (item) {
    var ai = activeItem;
    //Decide Active Element
    ai = activeItem.split('_');
    var activeStyle = item.toLowerCase().includes(ai[0]) ? activeClass : "";
    return _react2.default.createElement(
      "div",
      {
        key: item + "adwad",
